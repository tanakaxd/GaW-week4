...
namespace MalbersAnimations.Controller
{
    ...
    public class MAttackTriggerEd : Editor
    {
        ...
        MonoScript script;
        SerializedProperty SelfStatEnter, Trigger, PushForce, index, SelfStatExit, EnemyStatEnter, EnemyStatExit, debug, DebugColor, hitLayer, triggerInteraction, ModeID, Ability;
